...
export default function CreateAccountDetails() {
  return (
    <section className="flex flex-col">
      ...
      <div className="mt-[70px] h-[888px] mb-[50px] bg-[#F9F9F9] py-[68px]">
        <div className="w-[clamp(645px,86vw,1248px)] h-full mx-auto flex">
          ...
          <div className="flex-1 -ml-[38px] max-[865px]:-ml-[0px] py-10 flex flex-col bg-[#FDFDFD] rounded-l-[34.67px] h-full">
